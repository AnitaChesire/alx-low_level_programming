 ...
 * @e_ident: pointer to an array with its ELF version.
 */
 ...
 * @e_ident: pointer to an arr with ELF ABI version.
 */
void print_abi(unsigned char *e_ident)
{
...
/**
 * main - Display info at the start of an ELF file.
 * @argc: no of args
